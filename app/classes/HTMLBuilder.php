...
?>
    ...
    {
        global $cml_script_start, $cml_db_request_amount;
        ...
        <div id="cmlInfoBar">
            <div class="cmlBarBegin">
                <div class="cmlHttpMethod"><?= $_SERVER['REQUEST_METHOD'] ?></div>
                <div class="cmlStatusCode statusCode_<?= $httpResponseRange[0] ?>00"><?= http_response_code() ?></div>
                <div class="cmlNameRoute">
                    <span class="cmlNameRoute__type"><?= $type ?></span>
                    <span><?= $this->currentRouteName ?></span>
                </div>
                <div class="cmlExecutionTime"><?= $cml_execution_time ?></div>
                <div class="cmlDBRequest">
            ...
            <div class="cmlBarEnd">
                <div>CML v<?= useTrait()::getFrameworkVersion() ?></div>
        ...
        <style>
            ...
            #cmlInfoBar div:not(.cmlBarBegin, .cmlBarEnd) {
                padding: 7px 15px;
            }
