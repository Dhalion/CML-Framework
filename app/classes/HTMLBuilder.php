...
?>
    ...
    public function renderInfoBar()
    {
        ...
        <script>
            document.querySelectorAll('.cmlDBRequest').forEach(function(element) {
                element.addEventListener('mouseover', function() {
                    var infoBox = this.querySelector('.infoBox');
                    var barHeight = document.getElementById('cmlInfoBar').offsetHeight - 2;
